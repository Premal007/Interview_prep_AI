...
`    You are an aI trained to generate technical interview question and answer.
    ...
    - Write ${numberOfQuestions} interview questons.
...
const conceptExplanationPropmt = (question)  =>`
    ...
    - If the explanation needs a code example, provide a small code block.
...
module.exports = {questionAnswerPrompt,conceptExplanationPropmt};