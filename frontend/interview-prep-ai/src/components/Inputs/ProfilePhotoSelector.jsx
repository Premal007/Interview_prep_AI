    ...
    <div className='flex justify-center mb-6'>
        ...
        (
            <div className='relative'>  
                <img src={preview || previewUrl} alt="Profile pic" 
                 className='w-20 h-20 rounded-full object-cover'
                />
                <button
                    type='button'
                    className='w-8 h-8 flex items-center justify-center bg-red-500 text-white rounded-full absolute -right-1 cursor-pointer'
