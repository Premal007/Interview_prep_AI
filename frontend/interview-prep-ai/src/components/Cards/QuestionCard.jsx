...
function QuestionCard({
  ...
  return (
    <>
    <div className='bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shaddow-gray-100/70 border border-gray-100/60 group'>
        ...
        <div className='flex items-start justify-between cursor-pointer'>
            <div className='flex items-start gap-3.5'>
                ...
                <h3 
                    className='texxt-xs md:text-[14px] font-medium text-gray-800 mr-0 md:mr-20'
        ...
        >
            <div
                ref={contentRef}
                className='mt-4 text-gray-700 bg-gray-50 px-5 py-7 rounded-lg'
            >
