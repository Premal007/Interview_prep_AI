    ...
    return (
        ...
        <div className='relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden'>
            ...
            <button 
                type='button'
                onClick={onClose} 
                className='text-gray-500 bg-transparent hover:bg-orange-100 hover:text-gray-900 rounded-lg text-sm w-8 h-8 flex items-center justify-center absolute top-3.5 right-3.5 cursor-pointer'
            >
                <svg 
                    className='w-3 h-3' 
                    aria-hidden="true" 
