  ...
  return (
    <>
      <div className='w-full min-h-full bg-[#FFFCEF]'> 
        ...
        <div className='w-11/12 container mx-auto px-4 pt-6 pb-[200px] relative z-10'>
          ...
          <div className='flex flex-col md:flex-row items-center'>
            <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-0'>
              ...
              <h1 className='text-5xl font-medium text-black mb-6 leading-tight'>
            ...
            <div className='w-full md:w-1/2'>
              <p className='text-[17px] text-gray-900 mr-0 md:mr-20 mb-6'>
                Get role-specific questions,expand answers when you need them,dive deeper into concepts,and organize everything yours way.
      ...
      <div className='w-full min-h-full relative z-10 '>
        <div>
          <section className='flex items-center justify-center -mt-36'>
            <img 
             src={HERO_IMG} 
             alt="Hero image" 
             className='rounded-lg h-[500px] w-[1000px]'
            />
          </section>
        </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                  {APP_FEATURES.slice(3).map((feature) =>(
                    ...
                    >
                        ...
                        <p className='text-gray-600'>{2}{feature.description}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className='text-sm bg-gray-50 text-secondary text-center p-5 mt-5'>
          Made with ❤️... Happy Interviewing!
        </div>
      </div>
